# RailsAdmin config file. Generated on June 01, 2013 15:55
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Calagator', 'Admin']
  ...
  # config.excluded_models = ['Event', 'Organization', 'Source', 'Topic', 'Type', 'Update', 'Venue']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'Organization', 'Source', 'Topic', 'Type', 'Update', 'Venue']
  ...
  #     configure :duplicate_of, :belongs_to_association 
  ...
  #     configure :duplicates, :has_many_association 
  ...
  #     configure :duplicate_of_id, :integer         # Hidden 
  #     configure :end_time, :datetime 
  #     configure :rrule, :string 
  #     configure :venue_details, :text 
  ...
  #     configure :organization, :belongs_to_association 
  #     configure :events, :has_many_association 
  #     configure :venues, :has_many_association 
  ...
  #     configure :title, :string 
  #     configure :url, :string 
  #     configure :imported_at, :datetime 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :reimport, :boolean 
  #     configure :organization_id, :integer         # Hidden 
  #     configure :site_id, :integer 
  ...
  #     configure :events, :has_and_belongs_to_many_association 
  #     configure :organizations, :has_and_belongs_to_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your venue.rb model definition
  ...
  #     configure :access_notes, :text 
  #     configure :events_count, :integer 
  #     configure :site_id, :integer 
