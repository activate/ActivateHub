Calagator::Application.configure do
  ...
  config.public_file_server.enabled = %w(true yes 1).include?(ENV['STATIC_ASSETS']) || false
  ...
  config.assets.precompile += %w( forms.css forms.js widget.css widget.js mustache.js admin.css admin.js )
